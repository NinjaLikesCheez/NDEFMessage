extension NDEF {
	final class URIRecord: Record {
		convenience init(_ uri: String, id: [UInt8]? = nil) {
			...
			let payload = [uriProtocol.identifier] + Array(trimmedURI.utf8)
			let type: [UInt8] = [0x55] // 'U' - see NFC RTD URI Spec 2.3.1
